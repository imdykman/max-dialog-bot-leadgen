...
async function handleDemoHairStep(ctx, userId, action, userStates) {
  ...
  switch (action) {
    case 'demo_hair_haircut': case 'demo_hair_color': case 'demo_hair_nails': case 'demo_hair_styling': {
      const services = {
        'demo_hair_haircut': { name: 'Стрижка', price: 'от 1500 ₽', emoji: '✂️' },
        'demo_hair_color': { name: 'Окрашивание', price: 'от 3500 ₽', emoji: '🎨' },
    ...
    case 'demo_hair_master_anna': case 'demo_hair_master_dima': case 'demo_hair_master_elena': {
      const masters = { 'demo_hair_master_anna': 'Анна', 'demo_hair_master_dima': 'Дмитрий', 'demo_hair_master_elena': 'Елена' };
      state.data.master = masters[action];
      await ctx.reply(`👤 *Мастер: ${state.data.master}*\n\nОтлично! Когда вам удобно прийти?`, {
        attachments: [Keyboard.inlineKeyboard([
    ...
    case 'demo_hair_today': case 'demo_hair_tomorrow': case 'demo_hair_day_after': {
      const dates = { 'demo_hair_today': 'сегодня', 'demo_hair_tomorrow': 'завтра', 'demo_hair_day_after': 'послезавтра' };
    ...
    case 'demo_hair_time_10': case 'demo_hair_time_12': case 'demo_hair_time_14': case 'demo_hair_time_16': case 'demo_hair_time_18': case 'demo_hair_time_20': {
    ...
    case 'demo_hair_confirm':
      ...
      trackEvent('demo_hair_complete', userId, state.data); break;
  }
